const CollectionSection = () => {
  return (
    <>
    <div>
      <h2 className="text-6xl pt-40 font-bold pl-10">Explore Collections</h2>
    </div>
    <div className="flex flex-col gap-12 mx-2  p-6">
      ...
      <div className="container1">
        ...
        <div className="md:w-4/5 md:pl-6">
          <h2 className="text-4xl font-semibold mb-4">Taclux</h2>
          ...
          <p className="text-gray-700 text-justify text-xl mb-6">
          ...
          <button className="active-gradient text-white font-sans px-3 py-2">Explore Collection</button>
        </div>
      </div>
      ...
      <div className="container1">
        ...
        <div className="md:w-4/5 md:pr-12">
          <h2 className="text-4xl font-semibold mb-4">UV</h2>
          <p className="text-gray-700 text-xl text-justify mb-4">
          ...
          <button className="active-gradient text-white px-3 py-2 font-sans">Explore Collection</button>
        </div>
      </div>
    </div>
    </>
